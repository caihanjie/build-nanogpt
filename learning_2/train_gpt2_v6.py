...
#torchrun --standalone --nproc_per_node=2 learning_2/train_gpt2_v6.py
...
max_lr = 6e-4
min_lr = max_lr * 0.1
warmup_steps = 715  # 3.75B / total_batch_size 2**19 
max_steps = 19073  # 10B tokens / total_batch_size 2**19 
