...
# make NCCL fail fast instead of hanging when an issue occurs
...
ddp = int(os.environ.get("RANK", -1)) != -1  # torchrun sets RANK/LOCAL_RANK/WORLD_SIZE
if ddp:
...
if master_process:
    print("using device:", device, "ddp:", ddp)
...
if master_process:
    ...
    print(decode(raw_model.generate(context, max_new_tokens=10000)[0].tolist()))
